...
Fallback if needed: `scripts/search_mathlib.sh "continuous.*real" name`
...
Running: scripts/analyze_let_usage.py Core.lean --line 45
...
Running: scripts/analyze_let_usage.py Core.lean --line 78
...
Fallback: scripts/search_mathlib.sh "continuous.*comp" name
