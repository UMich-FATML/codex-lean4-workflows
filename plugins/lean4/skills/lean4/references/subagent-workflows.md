...
- "Run scripts/sorry_analyzer.py and report count"
...
❌ Dispatch general-purpose agent to run scripts/find_golfable.py (misses false-positive filtering)

Task: "Find mathlib lemmas for this sorry"
✅ Dispatch Explore agent to run scripts/smart_search.sh (simple delegation)
...
**Scenario:** Running scripts/sorry_analyzer.py on a medium project
